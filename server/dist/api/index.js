...
apiRouter.get('/documents', validateQuery(schemas.documents.search), asyncHandler(async (req, res) => {
...
apiRouter.get('/procedures', validateQuery(schemas.procedures.search), asyncHandler(async (req, res) => {
    const userId = req.user.userId;
