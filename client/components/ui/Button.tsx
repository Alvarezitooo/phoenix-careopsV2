...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-xl font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary: 'bg-rose-500 text-white hover:bg-rose-600 focus-visible:ring-rose-300',
        secondary: 'border border-slate-300 text-slate-700 hover:bg-slate-50 focus-visible:ring-slate-300',
        ...
        success: 'bg-green-500 text-white hover:bg-green-600 focus-visible:ring-green-300',
      },
      size: {
        sm: 'h-8 px-3 text-sm',
        md: 'h-10 px-4',
